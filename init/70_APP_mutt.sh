...
echo ''
echo '# every minute, check for new emails for'
echo '# all accounts in ~/.mutt/accounts/ and'
echo '# download messages into ~/Mail/<account>/'
echo ''
echo '*/1 * * * * ~/bin/checkmail.sh 2>&1 | logger -tcheckmail'
echo ''
echo '##############################'
echo ''
echo ''
